...
def paginate_help(page_number, loaded_modules, prefix):
    ...
    modules = [
        custom.Button.inline("{} {} 〤".format("〤", x), data="ub_modul_{}".format(x))
    ...
    try:
        ...
        async def handler(event):
            if event.message.from_id != uid:
                await event.reply("do you want join ezbw? if yes [CLICK THIS](https://github.com/hbreakclub/ezbw.git)")
            else:
        ...
        async def inline_handler(event):
            ...
            if event.query.user_id == uid and query.startswith("@UserButt"):
                ...
                result = builder.article(
                    "**ezbw**",
                    text="""**Kamu juga bisa buat bot di:** [Grup Userbot](t.me/Lorduserbot_Group)""",
                    buttons=[
                        [
                            custom.Button.url(
                                "Repo ezbw",
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid:  # pylint:disable=E0602
                ...
                reply_pop_up_alert = f"Deploy 𝙚𝙯𝙗𝙬 Anda Sendiri, Jangan Menggunakan Milik {ALIVE_NAME} !!"
